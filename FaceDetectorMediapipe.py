...
class FaceDetector():
    ...
    def fancyDraw(self, img, bbox, l=30, t=5, rt= 1):
        ...
        # Top Right  x1,y
        #cv2.line(img, (x1, y), (x1 - l, y), self.bbox_color, t)
        #cv2.line(img, (x1, y), (x1, y+l), self.bbox_color, t)
        # Bottom Left  x,y1
        #cv2.line(img, (x, y1), (x + l, y1), self.bbox_color, t)
        #cv2.line(img, (x, y1), (x, y1 - l), self.bbox_color, t)
        # Bottom Right  x1,y1
